...
# Access Digital Ocean Spatial Storage Secret Key - Manny
export DIGITAL_OCEAN_SPACES_SECRET=redacted
# Access Digital Ocean Spatial Storage Access Key - Manny
export DIGITAL_OCEAN_SPACES_ACCESS=redacted
# Host Code for Database - Bryan
export DATABASE_URL=redacted
# Host Username for Database - Bryan
