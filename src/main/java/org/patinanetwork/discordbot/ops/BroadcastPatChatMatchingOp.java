...
/**
 * Operation to handle the BroadcastPatChatMatching endpoint.
 * Randomly matches active people in the discordUser table and sends a dm when matching is complete. 
 */
