...
public class JDAEventListener extends ListenerAdapter {
    ...
    public JDAEventListener(PatChatClient patChatClient, DiscordUserClient discordUserClient, View error) {
    ...
    public void onModalInteraction(ModalInteractionEvent event) {
        ...
        try {
            ...
            if ("patchats_modal".equals(event.getModalId())) {
                ...
                var patchatResponse = patChatClient
                ...
                discordUserClient.addDiscordUser(AddDiscordUserReq.newBuilder()
                        .setPatchatMemberId(patchatResponse)
