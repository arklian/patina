...
import org.patinanetwork.patinawebsite.auth.account.repo.PsqlAccountRepo;
...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private final PsqlAccountRepo psqlUsersRepo;
    private final PsqlAdminRepo psqlAdminRepo;

    public CustomAuthenticationSuccessHandler(PsqlAccountRepo psqlUsersRepo, PsqlAdminRepo psqlAdminRepo) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            boolean userExists = psqlUsersRepo.accountExists(email);
            boolean isAdmin = psqlAdminRepo.isAdmin(email);

            if(!userExists) {
                psqlUsersRepo.createAccount(email, username);
            }
