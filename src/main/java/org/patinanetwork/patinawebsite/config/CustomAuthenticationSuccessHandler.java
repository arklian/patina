...
import org.patinanetwork.patinawebsite.admin.repo.PsqlAdminRepo;
import org.patinanetwork.patinawebsite.user.repo.PsqlUsersRepo;
...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (!userExists) {
                psqlUsersRepo.createUser(email, username, role);
            }
