...
export function Socials() {
  ...
  return (
    <div className={classes.footer}>
      <Container fluid>
        <Group gap={0} justify="flex-start" align="start" wrap="nowrap">
          <Icon link="https://github.com/bz5989" icon={<SiGithub />} />
          <Icon link="mailto:bryan14916@gmail.com" icon={<SiGmail />} />
          <Icon
