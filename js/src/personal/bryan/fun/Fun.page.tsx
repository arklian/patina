...
export function FunPage() {
  ...
  return (
    <Flex mr="2rem" direction="column">
      ...
      <Grid ml="5rem" justify="flex-start" component="span">
        <Grid.Col span={{ base: 12, md: 6, lg: 3 }} order={{ base: 4, lg: 1 }}>
        ...
        <Grid.Col span={{ base: 12, md: 6, lg: 3 }} order={{ base: 1, lg: 2 }}>
        ...
        <Grid.Col span={{ base: 12, md: 6, lg: 3 }} order={{ base: 2, lg: 3 }}>
          <Title component="span" className={classes.title2}>
            {'Board Games'}
          </Title>
          <Space />
        ...
        <Grid.Col span={{ base: 12, md: 6, lg: 3 }} order={{ base: 3, lg: 4 }}>
