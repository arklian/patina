...
const accordionList = [
  ...
  },
  {
    ...
    content: "I graduated from the University of Washington-Bothell in the Fall of '24 with a BS of Science - CSSE." +
  ...
  },
  {
    ...
    content: "In my free time, I enjoy listening and making music. I listen to all genres of music and typically" +
...
export function MartinAbout() {
  ...
  return (
    <>
      ...
      <Container>
        <SoundCloudPlayer
          src={"https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1852463463&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"}
          width={"100%"}
          height={"300"}
        />
      </Container>
