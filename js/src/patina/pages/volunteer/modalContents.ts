export const modalContent1 = `**About Us:**
...
**Details:**
Part-time, unpaid (2 hrs/week). Start ASAP, end negotiable. Professional development and networking opportunities.

Join us in making a positive impact! 🌟`

export const modalContent2 = `**About Us:**
Patina Network Corporation is a nonprofit dedicated to advancing the interests of Asian American, Native Hawaiian, and Pacific Islander (AANHPI) communities through cultural awareness, social justice, and empowerment.
...
export const modalContent3 = `**About Us:**
Patina Network Corporation is a nonprofit dedicated to advancing the interests of Asian American, Native Hawaiian, and Pacific Islander (AANHPI) communities through cultural awareness, social justice, and empowerment.
...
export const modalContent4 = `**About Us:**
Patina Network Corporation is a nonprofit dedicated to advancing the interests of Asian American, Native Hawaiian, and Pacific Islander (AANHPI) communities through cultural awareness, social justice, and empowerment.
