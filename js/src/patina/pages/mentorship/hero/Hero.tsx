    ...
    <SimpleGrid cols={largeScreen ? 2 : 1} spacing="xl" mb={'7rem'} mt={'4rem'}>
      <div>
        ...
        <Text className={styles.description}>
          {'The Patina Network mentorship program is open to students currently ' +
            'enrolled in or who recently graduated from any U.S. college program and are ' +
            'interested in guidance on their workplace readiness.'}
        </Text>
      ...
      <Group justify={'center'} pt={'lg'}>
        <Image
          ...
          alt="Person being mentored in a brightly lit room}"
        />
      </Group>
    </SimpleGrid>
  )
