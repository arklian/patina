...
import { FaPeopleArrows, FaDiscord, FaUsers } from 'react-icons/fa'
import styles from './ProgramDetails.module.css'

/** Displays details for the mentorship program */
  ...
  return (
    <>
      <div className={styles.programDescription}>
        ...
        <Text>
          {
            "For the duration of the program, mentors and mentee pairs should meet weekly at any time that works for you two. Come with topics and questions that you'd like to get your mentor's perspective on!"
          }
        </Text>
        <p />
        <Text>
        ...
        <Text>
          {
            'The other will be an in-person gathering where all of the mentors and mentees can meet, to allow everyone to get to know each other and build a sense of community. We aim for the size program to be more intimate in size, so we can plan this programming around everyone’s availability. We expect everyone to do their best to attend these sessions to get the most out of the program.'
          }
        </Text>
        <p />

        <Text fw={800} c={theme.other.patinaBlueLight}>
          {
            'The overall commitment for mentees is expected be around 6 hrs/month.'
          }
        </Text>
      </div>
    </>
